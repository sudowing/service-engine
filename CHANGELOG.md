...
## [1.9.1] - 2021-11-14
### Fixed
- Updated `x-get-count` query builder for REST calls with using `distinct`.
...
[Unreleased]: https://github.com/sudowing/service-engine/compare/v1.9.1...HEAD
[1.9.0]: https://github.com/sudowing/service-engine/compare/v1.9.0...v1.9.1
